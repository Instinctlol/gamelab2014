...
namespace ProjectEntities
{
    ...
    /// <summary>
    /// Defines the <see cref="KleineAlienAI"/> entity type.
    /// </summary>
    public class KleineAlienAIType : AIType //Klasse KleineAlienAIType abgeleitet von AIType
    {
    }
    ...
    /// </summary>
    public class KleineAlienAI : AI //Klasse KleineAlienAI abgeleitet von AI
    {
        //cached list of weapons for better performance
        Weapon[] weapons;

        // Serialisierung zur Speicherung von Variablen, um diese wiederzubekommen
        [FieldSerialize]
        ...
        public abstract class Task
        {
            ...
            protected Task(KleineAlienAI owner, Vec3 position, MapObject entity)
            {
                this.owner = owner;
        ...
        {
            public IdleTask(KleineAlienAI owner)
        ...
        public class MoveTask : Task
        {
            ...
            public MoveTask(KleineAlienAI owner, Vec3 position, float reachDistance)
                : base(owner, position, null)
            {
                this.reachDistance = reachDistance;
            }

            public MoveTask(KleineAlienAI owner, MapObject entity, float reachDistance)
        ...
        {
            public AttackTask(KleineAlienAI owner, Vec3 position)
                : base(owner, position, null) { }
            public AttackTask(KleineAlienAI owner, MapObject entity)
                : base(owner, Vec3.Zero, entity) { }
            ...
            bool CheckDirectVisibilityByRayCast(Vec3 from, Vec3 targetPosition, MapObject targetObject)
            {
                ...
                EngineConsole.Instance.Print("Bla" + controlledObj.Type.OptimalAttackDistanceRange.Maximum);

                Map.Instance.GetObjects(new Sphere(targetPosition, controlledObj.Type.OptimalAttackDistanceRange.Maximum), delegate(MapObject obj)
                {
                    PlayerCharacter playerCh = obj as PlayerCharacter;
                                                         
                    //skip target object  //skip controlled object
                    if (playerCh != null && targetObject != null && obj != targetObject && obj != controlledObj)
                        returnValue = false;
        ...
        //stellt eine Verbindung zwischen "game object type" und "game code" her
        KleineAlienAIType _type = null; public new KleineAlienAIType Type { get { return _type; } }


        public KleineAlienAI()
        {
        ...
        Task CreateTaskByClassName(string className)
        {
            ...
            Log.Fatal("KleineAlienAI: CreateTaskByClassName: Unknown task class name {0}.", className);
            return null;
        }
        ...
        string GetTaskClassName(Task task)
        {
            ...
            Log.Fatal("KleineAlienAI: GetTaskClassName: Unknown task class.");
            return "";
        }
