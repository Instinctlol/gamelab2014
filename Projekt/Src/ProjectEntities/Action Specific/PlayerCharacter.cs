...
namespace ProjectEntities
{
    ...
    public class PlayerCharacter : GameCharacter
    {
        ...
        [Browsable(false)]
        public double FlashLightPitch
        {
            get { return flashLightPitch; }
            set
            {

                flashLightPitch = value;

                if (EntitySystemWorld.Instance.IsServer())
                    Server_SendFlashLightRotation(flashLightPitch);
            }
        }
        ...
        private void Server_SendFlashLightRotation(double pitch)
        {
            SendDataWriter writer = BeginNetworkMessage(typeof(PlayerCharacter),
