...
namespace Game
{
	public class MultiplayerLoginWindow : Control
	{
		...
		protected override void OnAttach()
		{
			...
			//create window
			window = ControlDeclarationManager.Instance.CreateControl("Gui\\CustomMultiplayerLoginWindow.gui");
			Controls.Add( window );
		...
		void CreateServer_Click( Button sender )
		{
			...
			GameNetworkServer server = new GameNetworkServer( "AVA Server",	EngineVersionInformation.Version, 3, true );
