...
{
    /// <summary>
    /// Algorithm for diagonal lines, which trend from top left to bottom right.
    /// </summary>
    public class DiagonalTopLeftBottomRightGestureAlgorithm : IPointerGestureAlgorithm
    {
        #region IPointerGestureAlgorithm Members

        /// <summary>
        /// Calculates the matching value for a diagonal line, which trends from top left to bottom right.
        /// </summary>
