...
{
    /// <summary>
    /// Algorithm for diagonal lines, which trend from top right to bottom left.
    /// </summary>
    public class DiagonalTopRightBottomLeftGestureAlgorithm : IPointerGestureAlgorithm
    {
        #region IPointerGestureAlgorithm Members

        /// <summary>
        /// Calculates the matching value for a diagonal line, which trends from top right to bottom left.
        /// </summary>
