...
{
	public class Terminal_C_Door : Engine.EntitySystem.LogicSystem.LogicEntityObject
	{
		ProjectEntities.Terminal __ownerEntity;
		
		public Terminal_C_Door( ProjectEntities.Terminal ownerEntity )
			: base( ownerEntity )
		{
		...
		{
			Computer.Instance.SetSectorGroupPowerAstronaut((SectorGroup)Entities.Instance.GetByName("F1SG-C"),true);
		}
