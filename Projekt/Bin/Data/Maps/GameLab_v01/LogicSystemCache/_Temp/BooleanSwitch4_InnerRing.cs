...
{
	public class BooleanSwitch4_InnerRing : Engine.EntitySystem.LogicSystem.LogicEntityObject
	{
		ProjectEntities.BooleanSwitch __ownerEntity;
		
		public BooleanSwitch4_InnerRing( ProjectEntities.BooleanSwitch ownerEntity )
			: base( ownerEntity )
		{
