...
{
	public class BooleanSwitch1_InnerRing : Engine.EntitySystem.LogicSystem.LogicEntityObject
	{
		ProjectEntities.BooleanSwitch __ownerEntity;
		
		public BooleanSwitch1_InnerRing( ProjectEntities.BooleanSwitch ownerEntity )
			: base( ownerEntity )
		{
