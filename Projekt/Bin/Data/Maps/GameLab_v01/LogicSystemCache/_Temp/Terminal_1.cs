...
{
	public class Terminal_1 : Engine.EntitySystem.LogicSystem.LogicEntityObject
	{
		ProjectEntities.Terminal __ownerEntity;
		
		public Terminal_1( ProjectEntities.Terminal ownerEntity )
			: base( ownerEntity )
		{
		...
		{
			Engine.EntitySystem.LogicClass __class = Engine.EntitySystem.LogicSystemManager.Instance.MapClassManager.GetByName( "Terminal_1" );
