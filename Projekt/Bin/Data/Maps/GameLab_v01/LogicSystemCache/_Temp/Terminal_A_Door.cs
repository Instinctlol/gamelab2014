...
{
	public class Terminal_A_Door : Engine.EntitySystem.LogicSystem.LogicEntityObject
	{
		ProjectEntities.Terminal __ownerEntity;
		
		public Terminal_A_Door( ProjectEntities.Terminal ownerEntity )
			: base( ownerEntity )
		{
		...
		{
			Computer.Instance.SetSectorGroupPowerAstronaut((SectorGroup)Entities.Instance.GetByName("F1SG-A"),true);
		}
