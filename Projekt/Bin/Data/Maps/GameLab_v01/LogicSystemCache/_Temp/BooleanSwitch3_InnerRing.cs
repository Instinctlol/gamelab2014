...
{
	public class BooleanSwitch3_InnerRing : Engine.EntitySystem.LogicSystem.LogicEntityObject
	{
		ProjectEntities.BooleanSwitch __ownerEntity;
		
		public BooleanSwitch3_InnerRing( ProjectEntities.BooleanSwitch ownerEntity )
			: base( ownerEntity )
		{
