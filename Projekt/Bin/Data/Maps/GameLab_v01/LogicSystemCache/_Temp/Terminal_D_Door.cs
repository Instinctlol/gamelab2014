...
{
	public class Terminal_D_Door : Engine.EntitySystem.LogicSystem.LogicEntityObject
	{
		ProjectEntities.Terminal __ownerEntity;
		
		public Terminal_D_Door( ProjectEntities.Terminal ownerEntity )
			: base( ownerEntity )
		{
		...
		{
			Computer.Instance.SetSectorGroupPowerAstronaut((SectorGroup)Entities.Instance.GetByName("F1SG-D"),true);
		}

		public void TerminalRotateLeftAction()
		{
			Computer.Instance.AstronautRotateRing((Ring)Entities.Instance.GetByName("F2_Ring"),true);
		}

		public void TerminalRotateRightAction()
		{
			Computer.Instance.AstronautRotateRing((Ring)Entities.Instance.GetByName("F2_Ring"),false);
		}
