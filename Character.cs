...
namespace ProjectEntities
{
	...
	public class Character : Unit
	{
        ...
        protected override void OnDie(MapObject prejudicial)
        {
            ...
            // Timer für richtiges Sterben erstellen
            deathTimer = new Timer(30000); //30 Sec
            deathTimer.Elapsed += new ElapsedEventHandler(_timer_Elapsed);
            deathTimer.Enabled = true; // Enable it

        }

        private void _timer_Elapsed(object sender, ElapsedEventArgs e)
        {
            // hier wirklich sterben
            base.OnDie(this.prejudicial);
        }
		...
		protected override void OnTick()
		{
            ...
            // prüfen, ob Kumpel in Nähe während ich tod bin
            if (isDead) // && kumpel ist in Nähe?
            {
                // Kontrolle wieder akivieren
                isDead = false;
                // Ganz wichtig, den Timer wieder abstellen
